...
VALUES ('홍길동', 'hong@example.com', 'password123', '010-1111-1111', 180.0, 75.0, '왼발', '서울', 'ST', 90, 85, 88, 82, 80,
        78, 150, 50, 30, 15, '1985-03-15', '열정적인 공격수입니다.', false, 'MALE', 'ROLE_USER', 'NONE'),
       ('김철수', 'kim@example.com', 'password123', '010-2222-2222', 175.0, 70.0, '오른발', '부산', 'GK', 85, 80, 87, 78, 75,
        82, 180, 45, 40, 20, '1988-06-12', '경기 집중력이 뛰어납니다.', false, 'MALE', 'ROLE_USER', 'NONE'),
       ('박영희', 'park@example.com', 'password123', '010-3333-3333', 165.0, 55.0, '양발', '경기', 'RW', 78, 72, 80, 75, 72,

        70, 120, 35, 25, 10, '1992-11-20', '빠른 윙어입니다.', false, 'FEMALE', 'ROLE_USER', 'NONE'),
       ('이민호', 'lee@example.com', 'password123', '010-4444-4444', 170.0, 68.0, '오른발', '대전', 'CM', 82, 78, 85, 80, 78,
        75, 180, 20, 50, 18, '1990-01-05', '경기를 조율하는 미드필더.', true, 'MALE', 'ROLE_USER', 'NONE'),
       ('최지우', 'choi@example.com', 'password123', '010-5555-5555', 185.0, 78.0, '왼발', '광주', 'CB', 88, 85, 90, 85, 88,
        82, 190, 55, 35, 22, '1987-08-22', '단단한 수비수입니다.', true, 'MALE', 'ROLE_USER', 'NONE'),
       ('장혜진', 'jang@example.com', 'password123', '010-6666-6666', 160.0, 52.0, '오른발', '대구', 'LW', 75, 70, 78, 72, 75,
        70, 140, 25, 30, 10, '1994-05-17', '빠르고 기술적인 선수입니다.', false, 'FEMALE', 'ROLE_USER', 'NONE'),
       ('윤석현', 'yoon@example.com', 'password123', '010-7777-7777', 178.0, 72.0, '왼발', '울산', 'LB', 85, 80, 87, 82, 80,
        78, 165, 30, 20, 12, '1991-12-03', '확실한 수비수입니다.', true, 'MALE', 'ROLE_USER', 'NONE'),
       ('김하늘', 'kimhaneul@example.com', 'password123', '010-8888-8888', 182.0, 75.0, '양발', '제주', 'ST', 90, 88, 92, 85,
        90, 85, 170, 50, 25, 10, '1996-02-14', '양발을 잘 쓰는 공격수입니다.', false, 'MALE', 'ROLE_USER', 'NONE'),
       ('오준영', 'oh@example.com', 'password123', '010-9999-9999', 175.0, 70.0, '오른발', '세종', 'RM', 78, 75, 80, 78, 75, 72,
        120, 28, 32, 11, '1993-07-01', '기술이 뛰어난 미드필더입니다.', true, 'MALE', 'ROLE_USER', 'NONE'),
       ('정수민', 'jung@example.com', 'password123', '010-1010-1010', 165.0, 60.0, '왼발', '전남', 'CB', 85, 82, 87, 80, 85,
        80, 190, 55, 40, 22, '1995-11-11', '경험이 많은 수비수입니다.', false, 'FEMALE', 'ROLE_USER', 'NONE');


-- tbl_club 테이블에 데이터 삽입
INSERT INTO tbl_club (club_owner_id, club_name, club_introduction, club_code,  member_count, stadium_name, city, region, age_group, gender)
VALUES
    (1, 'Seoul FC', '서울 최고의 구단입니다.', 'SEO123',  0,'서울 월드컵 경기장', '서울', '서울특별시', '20대', '남성'),
    (2, 'Busan United', '부산 최고의 구단입니다.', 'BUS456',  0,'부산 아시아드 경기장', '부산', '부산광역시', '30대', '남성'),
    (3, 'Incheon City', '인천에서 최고의 실력을 자랑하는 구단입니다.', 'INC789', 0, '인천 송도 경기장', '인천', '인천광역시', '20대', '여성'),
    (4, 'Daegu FC', '대구에서 활동하는 구단입니다.', 'DAE321',  0, '대구 스타디움', '대구', '대구광역시', '40대', '남성'),
    (5, 'Jeonju FC', '전주에서 활동하는 구단입니다.', 'JEO654', 0,  '전주월드컵 경기장', '전주', '전라북도', '30대', '여성'),
    (6, 'Gwangju United', '광주의 자랑스러운 구단입니다.', 'GWA987',  0,'광주월드컵 경기장', '광주', '광주광역시', '20대', '남성'),
    (7, 'Ulsan FC', '울산의 강력한 구단입니다.', 'ULS258', 0,  '울산문수축구경기장', '울산', '울산광역시', '30대', '여성'),
    (8, 'Daejeon Citizen', '대전의 대표 구단입니다.', 'DAE369',0,'대전 월드컵 경기장', '대전', '대전광역시', '40대', '남성'),
    (9, 'Jeju United', '제주의 강력한 구단입니다.', 'JEJ147', 0,  '제주월드컵경기장', '제주', '제주특별자치도', '20대', '여성'),
    (10, 'Suwon Bluewings', '수원의 자랑스러운 구단입니다.', 'SUW369',0, '수원월드컵경기장', '수원', '경기도', '30대', '남성');

...
(name, email, password, phone_number, height, weight, main_foot, area, position, stamina, defend, speed, pass, shoot, dribble, total_match, total_score, total_assist, total_mom, birth, introduction, is_pro, gender, authority, social_type)
VALUES
    ('홍길동', 'hong@example.com', 'password123', '010-1111-1111', 180.0, 75.0, '왼발', '서울', 'ST',  90, 85, 88, 82, 80, 78, 150, 50, 30, 15, '1985-03-15', '열정적인 공격수입니다.', false, 'MALE', 'USER', 'NONE'),
    ('김철수', 'kim@example.com', 'password123', '010-2222-2222', 175.0, 70.0, '오른발', '부산', 'GK',  85, 80, 87, 78, 75, 82, 180, 45, 40, 20, '1988-06-12', '경기 집중력이 뛰어납니다.', false, 'MALE', 'USER', 'NONE'),
    ('박영희', 'park@example.com', 'password123', '010-3333-3333', 165.0, 55.0, '양발', '경기', 'RW',  78, 72, 80, 75, 72, 70, 120, 35, 25, 10, '1992-11-20', '빠른 윙어입니다.', false, 'FEMALE', 'USER', 'NONE'),
    ('이민호', 'lee@example.com', 'password123', '010-4444-4444', 170.0, 68.0, '오른발', '대전', 'CM',  82, 78, 85, 80, 78, 75, 180, 20, 50, 18, '1990-01-05', '경기를 조율하는 미드필더.', true, 'MALE', 'USER', 'NONE'),
    ('최지우', 'choi@example.com', 'password123', '010-5555-5555', 185.0, 78.0, '왼발', '광주', 'CB',  88, 85, 90, 85, 88, 82, 190, 55, 35, 22, '1987-08-22', '단단한 수비수입니다.', true, 'MALE', 'USER', 'NONE'),
    ('장혜진', 'jang@example.com', 'password123', '010-6666-6666', 160.0, 52.0, '오른발', '대구', 'LW',  75, 70, 78, 72, 75, 70, 140, 25, 30, 10, '1994-05-17', '빠르고 기술적인 선수입니다.', false, 'FEMALE', 'USER', 'NONE'),
    ('윤석현', 'yoon@example.com', 'password123', '010-7777-7777', 178.0, 72.0, '왼발', '울산', 'LB',  85, 80, 87, 82, 80, 78, 165, 30, 20, 12, '1991-12-03', '확실한 수비수입니다.', true, 'MALE', 'USER', 'NONE'),
    ('김하늘', 'kimhaneul@example.com', 'password123', '010-8888-8888', 182.0, 75.0, '양발', '제주', 'ST',  90, 88, 92, 85, 90, 85, 170, 50, 25, 10, '1996-02-14', '양발을 잘 쓰는 공격수입니다.', false, 'MALE', 'USER', 'NONE'),
    ('오준영', 'oh@example.com', 'password123', '010-9999-9999', 175.0, 70.0, '오른발', '세종', 'RM',  78, 75, 80, 78, 75, 72, 120, 28, 32, 11, '1993-07-01', '기술이 뛰어난 미드필더입니다.', true, 'MALE', 'USER', 'NONE'),
    ('정수민', 'jung@example.com', 'password123', '010-1010-1010', 165.0, 60.0, '왼발', '전남', 'CB',  85, 82, 87, 80, 85, 80, 190, 55, 40, 22, '1995-11-11', '경험이 많은 수비수입니다.', false, 'FEMALE', 'USER', 'NONE');
